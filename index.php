...
<nav id="navbar">
  ...
  <ul class="nav-links">
    ...
    <li><a href="/ai/public/login" style="color: var(--green); font-weight: 600;">Login</a></li>
  </ul>
  <a href="/ai/public/login" class="nav-cta" style="background: var(--green);">Login</a>
  ...
  <div class="section-inner">
    <div class="cta-box reveal">
      ...
      <p style="margin-top: 1.5rem; color: var(--muted); font-size: 0.85rem;">
        Already a client? <a href="/ai/public/login" style="color: var(--green); font-weight: 600; text-decoration: none;">Access Your Dashboard →</a>
      </p>
    </div>
  </div>
</section>
