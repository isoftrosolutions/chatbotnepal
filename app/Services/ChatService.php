...
class ChatService
{
    ...
    public function getOrCreateConversation(
        ...
        if ($conversationId) {
            ...
            if ($conversation) {
                $updates = [];
                if ($visitorName && ! $conversation->visitor_name) {
                    $updates['visitor_name'] = $visitorName;
                }
                if ($visitorEmail && ! $conversation->visitor_email) {
                    $updates['visitor_email'] = $visitorEmail;
                }
                if ($visitorPhone && ! $conversation->visitor_phone) {
                    $updates['visitor_phone'] = $visitorPhone;
                }
                if ($updates) {
        ...
        return ChatConversation::create([
            'user_id' => $client->id,
            'visitor_id' => $visitorId ?? Str::uuid()->toString(),
